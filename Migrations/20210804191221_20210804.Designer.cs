...
namespace CourtHouse.Migrations
{
    ...
    [Migration("20210804191221_20210804")]
    partial class _20210804
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourtHouse.Models.Beneficiary", b =>
                {
                    ...
                    b.Property<string>("realtyContractidRealtyContract")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("idBeneficiary");

                    b.HasIndex("personidNumber");

                    b.HasIndex("realtyContractidRealtyContract");
            ...
            modelBuilder.Entity("CourtHouse.Models.Fees", b =>
                {
                    ...
                    b.Property<int?>("paymentMethodidPaymentMethod")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("paymentMethodidPaymentMethod");
            ...
            modelBuilder.Entity("CourtHouse.Models.OfficialDocument", b =>
                {
                    b.Property<string>("idOfficialDocument")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("CourtHouse.Models.RealtyContract", b =>
                {
                    b.Property<string>("idRealtyContract")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("realtyidRealty")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("idRealtyContract");

                    b.HasIndex("realtyidRealty");
            ...
            modelBuilder.Entity("CourtHouse.Models.RealtyContractNote", b =>
                {
                    b.Property<string>("idRealtyContractNote")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("CourtHouse.Models.RealtyNote", b =>
                {
                    b.Property<string>("idRealtyNote")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("CourtHouse.Models.Beneficiary", b =>
                {
                    ...
                    b.HasOne("CourtHouse.Models.RealtyContract", "realtyContract")
                        .WithMany()
                        .HasForeignKey("realtyContractidRealtyContract");
            ...
            modelBuilder.Entity("CourtHouse.Models.Fees", b =>
                {
                    b.HasOne("CourtHouse.Models.PaymentMethod", "paymentMethod")
                        .WithMany()
                        .HasForeignKey("paymentMethodidPaymentMethod");
