...
namespace CourtHouse.Migrations
{
    ...
    [Migration("20220214214813_20220214_02")]
    partial class _20220214_02
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourtHouse.Models.Beneficiary", b =>
                {
                    ...
                    b.Property<int?>("waysToCommunicateid")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("waysToCommunicateid");
            ...
            modelBuilder.Entity("CourtHouse.Models.Person", b =>
                {
                    ...
                    b.Property<int?>("wayToCommunicateid")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CourtHouse.Models.RegionInfo", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<double>("AvaregDelayInCase")
                        .HasColumnType("float");

                    b.Property<int>("NumAllCases")
                        .HasColumnType("int");

                    b.Property<int>("NumEndCasesInThisMonth")
                        .HasColumnType("int");

                    b.Property<int>("NumUnfinishedCases")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CourtHouse.Models.WaysToCommunicate", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CourtHouse.Models.Beneficiary", b =>
                {
                    ...
                    b.HasOne("CourtHouse.Models.WaysToCommunicate", "waysToCommunicate")
                        .WithMany()
                        .HasForeignKey("waysToCommunicateid");

                    b.Navigation("person");

                    b.Navigation("realtyContract");

                    b.Navigation("waysToCommunicate");
                });
            ...
            modelBuilder.Entity("CourtHouse.Models.Person", b =>
                {
                    ...
                    b.HasOne("CourtHouse.Models.WaysToCommunicate", "wayToCommunicate")
                        .WithMany()
                        .HasForeignKey("wayToCommunicateid");

                    b.Navigation("region");

                    b.Navigation("wayToCommunicate");
                });
